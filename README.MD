...
- `GET /books/list` - View all books (protected)
...
### Routes Protection
- Book management (list, add, delete) - Prevent unauthorized inventory changes
...
- Not production-ready without proper access control